...
import { InstitutionProfileService } from "../services/profileInstitution.service";
import { InstitutionProfileController } from "../controllers/profileInstitution.controller";
...
router.post("/",upload.single("logoUrl"),validate(profileInstitutionValidator), controller.create)
router.put("/", upload.single("logoUrl"),validate(profileInstitutionValidator),controller.update)
